...
const MembresFormationExterneScreen = () => {
  ...
  const fetchParticipants = async () => {
    try {
      ...
      // Get cabinet info from session data
      if (sessionData?.nom_cabinet) {
        setCabinet({
          Nom: sessionData.nom_cabinet,
          telephone: sessionData.telephone_cabinet,
          Emplacement: sessionData.emplacement_cabinet
        });
      }
  ...
  return (
    <View style={styles.container}>
      {/* Cabinet Information */}
      {cabinet && (
        <Card style={styles.cabinetCard}>
          <Card.Content>
            <Title style={styles.cabinetTitle}>{STRINGS.CABINET_FORMATION}</Title>
            <Paragraph style={styles.cabinetName}>{cabinet.Nom}</Paragraph>
            {cabinet.telephone && (
              <Paragraph style={styles.cabinetDetails}>
                {STRINGS.TELEPHONE}: {cabinet.telephone}
              </Paragraph>
            )}
            {cabinet.Emplacement && (
              <Paragraph style={styles.cabinetDetails}>
                {STRINGS.EMPLACEMENT}: {cabinet.Emplacement}
              </Paragraph>
            )}
          </Card.Content>
        </Card>
...
export default MembresFormationExterneScreen;
